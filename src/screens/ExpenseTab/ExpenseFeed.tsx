...
class ExpenseFeed extends Component<IDefaultNavProps, IState> {
    ...
    viewDetails(key: number, navigate: any) {
        ...
        navigate(screen, {key: key, expense: expense, expenseArray: this.state.expenseArray, expenseArrayId: this.state.expenseArrayId, updateFeedState: this.updateState});
    }
